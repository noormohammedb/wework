RssFeed.publish('jobs', function(query) {
  ...
  self.setValue('title', self.cdata('jo-bs.com - Recent Jobs'));
  self.setValue('description', self.cdata('This is a feed of recent jobs posted to jo-bs.com.'));
...
var profileRss = function(query) {
  ...
  self.setValue('title', self.cdata('jo-bs.com - Recent Profiles'));
  self.setValue('description', self.cdata('This is a feed of recent profiles listed on jo-bs.com.'));
  self.setValue('link', Meteor.absoluteUrl());
  self.setValue('lastBuildDate', lastBuildDate);
  self.setValue('pubDate', pubDate);
  self.setValue('ttl', 1);
